...
public class Menu {
	...
	// Variaveis para a média, mediana, maximo, minimo e desvio padrao para o
		...
		do {
			...
			if (opcao == 1) {
				...
				for (int numberOfItem : FileSize) {
					...
					out.println("\nTempo maximo de inserção: " + maximo_push + " ns");// imprime
																						// na
																						// consola
					file.println("Tempo maximo de inserção: " + maximo_push + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Tempo minimo de inserção: " + minimo_push + " ns");// imprime
																					// na
																					// consola
					file.println("Tempo minimo de inserção: " + minimo_push + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Tempo medio de inserção: " + media_push + " ns");// imprime
																					// na
																					// consola
					file.println("Tempo medio de inserção: " + media_push + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Mediana de inserção: " + mediana_push + " ns");// imprime
																				// na
																				// consola
					file.println("Mediana de inserção: " + mediana_push + "ns");// imprime
																				// no
																				// exel
					...
					out.println("Desvio padrão: " + desvio_push + " ns");// imprime
																			// na
																			// consola
					file.println("Desvio padrão: " + desvio_push + "ns");// imprime
																			// no
																			// exel
					...
					out.println("\nTempo maximo de remoção: " + maximo_pop + " ns");// imprime
																					// na
																					// consola
					file1.println("Tempo maximo de remoção: " + maximo_pop + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Tempo minimo de remoção: " + minimo_pop + " ns");// imprime
																					// na
																					// consola
					file1.println("Tempo minimo de remoção: " + minimo_pop + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Tempo medio de remoção: " + media_pop + " ns");// imprime
																				// na
																				// consola
					file1.println("Tempo medio de remoção: " + media_pop + "ns");// imprime
																					// no
																					// exel
					...
					out.println("Mediana de remoção: " + mediana_pop + " ns");// imprime
																				// na
																				// consola
					file1.println("Mediana de remoção: " + mediana_pop + "ns");// imprime
																				// no
																				// exel
					...
					out.println("Desvio padrão: " + desvio_pop + " ns");// imprime
																		// na
																		// consola
					file1.println("Desvio padrão: " + desvio_pop + "ns");// imprime
																			// no
																			// exel
			...
			// Insertion Sort Medir tempo de ordenação para ficheiros sorted,
			// partially sorted e shuffled
			else if (opcao == 9) {
				...
				for (String orderType : OrderType) {
					for (int numberOfItem : FileSize) {
						...
						// Apenas não é feito a operação de ordenação quando o
						// orderType é shuffled e numberOfItem < 65536
