	...
	public static void main(String[] args) throws IOException {
		...
		for (String Type : FileType) {
			...
			for (int Item : FileSize) {
				...
				// variavel que diz localizacao dos ficheiros txt, o Item é
				// referente a cada nº do FileSize
				...
				if (FileExists == true) {
					...
					// Ciclo que apenas serve para imprimir na consola o tipo de
					// ficheiro que esta a ser analisado
					if (Type == "sorted") {
						out.println("-----------------------------------");
						out.println("Sorted");
					...
					// Tivemos que utilizar a classe InstrumentedMerge para
					// ordenar cada ficheiro, porque só nessa classe é que
					// conseguimos saber as interações que estão acontecer no
					// Array
					InstrumentedMerge.sort(textFiles);

					// vai aceder ao metodo getNumberOfComparisons() da classe
					// InstrumentedMerge e retorna o nº de comparações feitos no
					// merge, do textFiles em causa
					out.println("Número de comparações: " + InstrumentedMerge.getNumberOfComparisons());
					// vai aceder ao metodo getNumberOfArrayAccesses() da classe
					// InstrumentedMerge e retorna o nº de acessos feitos no
					// merge, do textFiles em causa
					out.println("Número de acesso ao Array: " + InstrumentedMerge.getNumberOfArrayAccesses());
					// vai aceder ao metodo getNumberOfArrayReads() da classe
					// InstrumentedMerge e retorna o nº de leituras feitas no
					// merge, do textFiles em causa
					out.println("Número de leitura dos Array: " + InstrumentedMerge.getNumberOfArrayReads());
					// vai aceder ao metodo getNumberOfArrayWrites() da classe
					// InstrumentedMerge e retorna o nº de escritas feitas no
					// merge, do textFiles em causa
