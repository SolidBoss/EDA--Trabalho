...
public class ResizingArrayFileVersao2 {
	...
	public static final double timeBudgetPerExperiment = 2.0;/* nano seconds */
	...
	*/
	...
	public static final double minimumTimePerContiguousRepetitions =  2e-5; /* nano seconds */
