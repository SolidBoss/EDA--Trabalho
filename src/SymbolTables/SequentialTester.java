...
public static long runSequentialInsert(String orderType, int numberOfItem) throws FileNotFoundException {
...
public static long searchSequentialSuccess(String orderType, int numberOfItem) throws FileNotFoundException {
	...
	public static long runSequentialDelete(String orderType, int numberOfItem) throws FileNotFoundException {
