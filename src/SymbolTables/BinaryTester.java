...
public class BinaryTester {
	...
	public static long runBinaryInsert(String orderType, int numberOfItem) throws FileNotFoundException {
		//ficheiro a analisar
	...
	public static long BinarySearchFail(String orderType, int numberOfItem) throws FileNotFoundException {
	...
	public static long BinarySearchSuccess(String orderType, int numberOfItem) throws FileNotFoundException {
	...
	public static long runBinaryDelete(String orderType, int numberOfItem) throws FileNotFoundException {
