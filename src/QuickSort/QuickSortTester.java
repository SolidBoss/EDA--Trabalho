...
public class QuickSortTester {
	...
	@SuppressWarnings({ "rawtypes", "resource", "unchecked" })
	public static void QuickSortWarmUp(String orderType, int Item) throws FileNotFoundException {
	...
	@SuppressWarnings({ "rawtypes", "resource", "unchecked" })
	public static long runAlgorithmQuick3way(String orderType, int Item) throws FileNotFoundException {
		...
		if (FileExists == true) {
				...
				long startTime = System.nanoTime();// Iniciar a medição em nanosegundos
				Quick3way.sort(textFiles);//Ordena cada ficheiro
				estimatedTime = System.nanoTime() - startTime;// Tempo Final guardado em variavel
	...
	//Metodo para o WarmUp
	@SuppressWarnings({ "rawtypes", "resource", "unchecked" })
	public static void Quick3wayWarmUp(String orderType, int Item) throws FileNotFoundException {
	...
	//Metodo para ler ler strings do txt, ordernar com o Quick3way e passar para o metodo getCountData
	@SuppressWarnings({ "rawtypes", "resource", "unchecked" })
	public static int[] runCountDataQuick3way(String orderType, int Item) throws FileNotFoundException {
		...
		if (FileExists==true) {	
			...
			Quick3way.sort(textFiles);//Ordena cada ficheiro
			countData = Quick3way.getCountData();//invoca o metodo getCountData e guarda os valores na variavel
